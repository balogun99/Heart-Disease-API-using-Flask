...
# installed.
TK_PREFIX='/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/macbookpro/Desktop/Heart Disease API Using Flask/ml_flask_api_heart/lib/libtkstub8.6.a'
